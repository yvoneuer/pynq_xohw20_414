...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_198 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_153_reg_222 <= {{eo_V_0_s_reg_81[62:1]}};
    end
end
...
assign i_7_fu_124_p2 = (i_fu_52 + 32'd1);

assign phitmp5_cast_fu_183_p3 = {{in_V_V_dout}, {tmp_154_fu_173_p4}};

assign phitmp_cast_fu_167_p3 = {{tmp_V_reg_217}, {tmp_153_reg_222}};

assign start_out = real_start;

assign t_2_fu_115_p2 = (ap_phi_mux_t_phi_fu_97_p4 + 10'd1);

assign tmp_154_fu_173_p4 = {{eo_V_1_s_reg_69[62:1]}};

assign tmp_s_fu_130_p2 = ((i_7_reg_207 == 32'd64) ? 1'b1 : 1'b0);

endmodule //Resid_StreamingDataW_9
