...
module Resid_StreamingDataW_12 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
wire   [9:0] t_11_fu_115_p2;
reg   [9:0] t_11_reg_202;
reg    ap_enable_reg_pp0_iter0;
wire   [31:0] i_11_fu_124_p2;
reg   [31:0] i_11_reg_207;
wire   [0:0] tmp_s_fu_130_p2;
wire    ap_block_state3_pp0_stage1_iter0;
reg    ap_block_state5_pp0_stage1_iter1;
reg    ap_block_pp0_stage1_11001;
reg   [15:0] tmp_V_reg_217;
reg   [95:0] tmp_161_reg_222;
wire   [111:0] phitmp_cast_fu_167_p3;
wire   [111:0] phitmp5_cast_fu_183_p3;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_198 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_161_reg_222 <= {{eo_V_0_s_reg_81[111:16]}};
    end
end
...
assign exitcond_fu_109_p2 = ((ap_phi_mux_t_phi_fu_97_p4 == 10'd800) ? 1'b1 : 1'b0);

assign i_11_fu_124_p2 = (i_fu_52 + 32'd1);

assign phitmp5_cast_fu_183_p3 = {{in_V_V_dout}, {tmp_162_fu_173_p4}};

assign phitmp_cast_fu_167_p3 = {{tmp_V_reg_217}, {tmp_161_reg_222}};

assign start_out = real_start;

assign t_11_fu_115_p2 = (ap_phi_mux_t_phi_fu_97_p4 + 10'd1);

assign tmp_162_fu_173_p4 = {{eo_V_1_s_reg_69[111:16]}};

assign tmp_s_fu_130_p2 = ((i_11_reg_207 == 32'd8) ? 1'b1 : 1'b0);

endmodule //Resid_StreamingDataW_12
