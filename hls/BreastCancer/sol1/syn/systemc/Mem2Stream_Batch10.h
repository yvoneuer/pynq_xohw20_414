...
#ifndef _Mem2Stream_Batch10_HH_
#define _Mem2Stream_Batch10_HH_
...
struct Mem2Stream_Batch10 : public sc_module {
    ...
    sc_out< sc_lv<64> > inter0_V_V_din;
    sc_in< sc_logic > inter0_V_V_full_n;
    sc_out< sc_logic > inter0_V_V_write;
    ...
    // Module declarations
    Mem2Stream_Batch10(sc_module_name name);
    SC_HAS_PROCESS(Mem2Stream_Batch10);
    ...
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_ap_start;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_ap_done;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_ap_idle;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_ap_ready;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_m_axi_in_V_AWVALID;
    sc_signal< sc_lv<64> > grp_Mem2Stream_fu_58_m_axi_in_V_AWADDR;
    sc_signal< sc_lv<1> > grp_Mem2Stream_fu_58_m_axi_in_V_AWID;
    sc_signal< sc_lv<32> > grp_Mem2Stream_fu_58_m_axi_in_V_AWLEN;
    sc_signal< sc_lv<3> > grp_Mem2Stream_fu_58_m_axi_in_V_AWSIZE;
    sc_signal< sc_lv<2> > grp_Mem2Stream_fu_58_m_axi_in_V_AWBURST;
    sc_signal< sc_lv<2> > grp_Mem2Stream_fu_58_m_axi_in_V_AWLOCK;
    sc_signal< sc_lv<4> > grp_Mem2Stream_fu_58_m_axi_in_V_AWCACHE;
    sc_signal< sc_lv<3> > grp_Mem2Stream_fu_58_m_axi_in_V_AWPROT;
    sc_signal< sc_lv<4> > grp_Mem2Stream_fu_58_m_axi_in_V_AWQOS;
    sc_signal< sc_lv<4> > grp_Mem2Stream_fu_58_m_axi_in_V_AWREGION;
    sc_signal< sc_lv<1> > grp_Mem2Stream_fu_58_m_axi_in_V_AWUSER;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_m_axi_in_V_WVALID;
    sc_signal< sc_lv<64> > grp_Mem2Stream_fu_58_m_axi_in_V_WDATA;
    sc_signal< sc_lv<8> > grp_Mem2Stream_fu_58_m_axi_in_V_WSTRB;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_m_axi_in_V_WLAST;
    sc_signal< sc_lv<1> > grp_Mem2Stream_fu_58_m_axi_in_V_WID;
    sc_signal< sc_lv<1> > grp_Mem2Stream_fu_58_m_axi_in_V_WUSER;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_m_axi_in_V_ARVALID;
    sc_signal< sc_lv<64> > grp_Mem2Stream_fu_58_m_axi_in_V_ARADDR;
    sc_signal< sc_lv<1> > grp_Mem2Stream_fu_58_m_axi_in_V_ARID;
    sc_signal< sc_lv<32> > grp_Mem2Stream_fu_58_m_axi_in_V_ARLEN;
    sc_signal< sc_lv<3> > grp_Mem2Stream_fu_58_m_axi_in_V_ARSIZE;
    sc_signal< sc_lv<2> > grp_Mem2Stream_fu_58_m_axi_in_V_ARBURST;
    sc_signal< sc_lv<2> > grp_Mem2Stream_fu_58_m_axi_in_V_ARLOCK;
    sc_signal< sc_lv<4> > grp_Mem2Stream_fu_58_m_axi_in_V_ARCACHE;
    sc_signal< sc_lv<3> > grp_Mem2Stream_fu_58_m_axi_in_V_ARPROT;
    sc_signal< sc_lv<4> > grp_Mem2Stream_fu_58_m_axi_in_V_ARQOS;
    sc_signal< sc_lv<4> > grp_Mem2Stream_fu_58_m_axi_in_V_ARREGION;
    sc_signal< sc_lv<1> > grp_Mem2Stream_fu_58_m_axi_in_V_ARUSER;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_m_axi_in_V_RREADY;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_m_axi_in_V_BREADY;
    sc_signal< sc_lv<64> > grp_Mem2Stream_fu_58_out_V_V_din;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_out_V_V_write;
    sc_signal< sc_logic > grp_Mem2Stream_fu_58_ap_start_reg;
    ...
    void thread_grp_Mem2Stream_fu_58_ap_start();
    void thread_inter0_V_V_din();
    void thread_inter0_V_V_write();
