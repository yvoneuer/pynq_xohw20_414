...
#ifndef _StreamingConvolution_5_HH_
#define _StreamingConvolution_5_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "BlackBoxJam_mux_42_128_1_1.h"
#include "StreamingConvolution_5_inputBuf_0_0_V.h"

namespace ap_rtl {

struct StreamingConvolution_5 : public sc_module {
    ...
    // Module declarations
    StreamingConvolution_5(sc_module_name name);
    SC_HAS_PROCESS(StreamingConvolution_5);

    ~StreamingConvolution_5();

    sc_trace_file* mVcdFile;

    StreamingConvolution_5_inputBuf_0_0_V* inputBuf_0_0_V_U;
    StreamingConvolution_5_inputBuf_0_0_V* inputBuf_0_1_V_U;
    StreamingConvolution_5_inputBuf_0_0_V* inputBuf_1_0_V_U;
    StreamingConvolution_5_inputBuf_0_0_V* inputBuf_1_1_V_U;
    StreamingConvolution_5_inputBuf_0_0_V* inputBuf_2_0_V_U;
    StreamingConvolution_5_inputBuf_0_0_V* inputBuf_2_1_V_U;
    StreamingConvolution_5_inputBuf_0_0_V* inputBuf_3_0_V_U;
    StreamingConvolution_5_inputBuf_0_0_V* inputBuf_3_1_V_U;
    BlackBoxJam_mux_42_128_1_1<1,1,128,128,128,128,2,128>* BlackBoxJam_mux_42_128_1_1_U415;
    BlackBoxJam_mux_42_128_1_1<1,1,128,128,128,128,2,128>* BlackBoxJam_mux_42_128_1_1_U416;
    ...
    sc_signal< sc_lv<1> > tmp_139_reg_888;
    sc_signal< sc_lv<1> > tmp_139_reg_888_pp0_iter1_reg;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<10> > i_reg_389;
    ...
    sc_signal< sc_lv<128> > reg_468;
    sc_signal< sc_lv<32> > grp_fu_449_p2;
    sc_signal< sc_lv<32> > reg_480;
    sc_signal< sc_lv<1> > grp_fu_484_p2;
    sc_signal< sc_lv<10> > i_s_fu_540_p2;
    sc_signal< sc_lv<10> > i_s_reg_879;
    sc_signal< sc_lv<1> > tmp_139_fu_555_p2;
    sc_signal< sc_lv<2> > tmp_1358_fu_570_p1;
    sc_signal< sc_lv<2> > tmp_1358_reg_892;
    sc_signal< sc_lv<32> > current_line_in_bloc_fu_580_p2;
    sc_signal< sc_lv<32> > current_line_in_bloc_reg_897;
    sc_signal< sc_lv<1> > tmp_142_fu_592_p2;
    sc_signal< sc_lv<1> > tmp_142_reg_902;
    sc_signal< sc_lv<1> > tmp_144_fu_603_p2;
    sc_signal< sc_lv<1> > tmp_144_reg_906;
    sc_signal< sc_lv<1> > tmp_146_fu_623_p2;
    sc_signal< sc_lv<1> > tmp_146_reg_910;
    sc_signal< sc_lv<32> > ofm_y_9_fu_637_p2;
    sc_signal< sc_lv<32> > ofm_y_9_reg_914;
    sc_signal< sc_lv<1> > tmp_147_fu_643_p2;
    sc_signal< sc_lv<1> > tmp_147_reg_919;
    sc_signal< sc_lv<1> > or_cond_reg_925_pp0_iter1_reg;
    sc_signal< sc_lv<32> > counter_internal_blo_2_fu_673_p2;
    sc_signal< sc_lv<32> > counter_internal_blo_2_reg_929;
    sc_signal< sc_lv<64> > tmp_141_fu_679_p1;
    sc_signal< sc_lv<64> > tmp_141_reg_935;
    sc_signal< sc_lv<1> > tmp_153_reg_963;
    sc_signal< sc_lv<1> > tmp_143_reg_967;
    sc_signal< sc_lv<2> > tmp_140_fu_747_p2;
    sc_signal< sc_lv<2> > tmp_140_reg_971;
    sc_signal< sc_lv<128> > inputBuf_0_0_V_q0;
    sc_signal< sc_lv<128> > inputBuf_0_0_V_loa_reg_977;
    sc_signal< sc_lv<128> > inputBuf_1_0_V_q0;
    sc_signal< sc_lv<128> > inputBuf_1_0_V_loa_reg_982;
    sc_signal< sc_lv<128> > inputBuf_2_0_V_q0;
    sc_signal< sc_lv<128> > inputBuf_2_0_V_loa_reg_987;
    sc_signal< sc_lv<128> > inputBuf_3_0_V_q0;
    sc_signal< sc_lv<128> > inputBuf_3_0_V_loa_reg_992;
    sc_signal< sc_lv<2> > tmp_1360_fu_767_p1;
    sc_signal< sc_lv<2> > tmp_1360_reg_1017;
    sc_signal< sc_lv<4> > inputBuf_0_1_V_add_2_reg_1021;
    sc_signal< sc_lv<4> > inputBuf_1_1_V_add_2_reg_1026;
    sc_signal< sc_lv<4> > inputBuf_2_1_V_add_2_reg_1031;
    sc_signal< sc_lv<4> > inputBuf_3_1_V_add_2_reg_1036;
    sc_signal< sc_lv<2> > tmp_1357_fu_783_p1;
    sc_signal< sc_lv<2> > tmp_1357_reg_1041;
    ...
    sc_signal< sc_lv<128> > inputBuf_0_1_V_loa_reg_1065;
    sc_signal< sc_lv<128> > inputBuf_1_1_V_q0;
    sc_signal< sc_lv<128> > inputBuf_1_1_V_loa_reg_1070;
    sc_signal< sc_lv<128> > inputBuf_2_1_V_q0;
    sc_signal< sc_lv<128> > inputBuf_2_1_V_loa_reg_1075;
    sc_signal< sc_lv<128> > inputBuf_3_1_V_q0;
    sc_signal< sc_lv<128> > inputBuf_3_1_V_loa_reg_1080;
    ...
    sc_signal< sc_lv<10> > ap_phi_mux_i_phi_fu_393_p4;
    sc_signal< sc_lv<64> > tmp_150_fu_755_p1;
    sc_signal< sc_lv<64> > tmp_138_fu_771_p1;
    sc_signal< sc_lv<128> > tmp_V_25_fu_787_p6;
    sc_signal< bool > ap_block_pp0_stage1_01001;
    sc_signal< sc_lv<128> > tmp_V_26_fu_797_p6;
    sc_signal< bool > ap_block_pp0_stage0_01001;
    sc_signal< sc_lv<32> > ofm_y_1_fu_76;
    sc_signal< sc_lv<32> > p_ofm_y_9_fu_693_p3;
    sc_signal< sc_lv<32> > ofm_x_1_fu_80;
    sc_signal< sc_lv<32> > ofm_x_9_fu_617_p2;
    sc_signal< sc_lv<32> > k_y_1_fu_84;
    sc_signal< sc_lv<32> > k_y_9_fu_574_p2;
    sc_signal< sc_lv<32> > inp_1_fu_88;
    sc_signal< sc_lv<32> > p_inp_1_fu_686_p3;
    sc_signal< sc_lv<32> > inp_6_fu_726_p2;
    sc_signal< sc_lv<32> > k_x_1_fu_92;
    sc_signal< sc_lv<32> > k_x_9_fu_586_p2;
    ...
    sc_signal< sc_lv<1> > tmp_148_fu_652_p2;
    sc_signal< sc_lv<1> > tmp_149_fu_658_p2;
    sc_signal< sc_lv<1> > tmp_156_fu_709_p2;
    sc_signal< sc_lv<2> > tmp_1359_fu_737_p1;
    ...
    void thread_counter_internal_blo_2_fu_673_p2();
    ...
    void thread_k_x_9_fu_586_p2();
    void thread_k_y_9_fu_574_p2();
    void thread_ofm_x_9_fu_617_p2();
    void thread_ofm_y_9_fu_637_p2();
    void thread_or_cond_fu_664_p2();
    void thread_out_V_V_blk_n();
    void thread_out_V_V_din();
    void thread_out_V_V_write();
    void thread_p_inp_1_fu_686_p3();
    void thread_p_ofm_y_9_fu_693_p3();
    void thread_p_s_fu_714_p3();
    void thread_real_start();
    void thread_start_out();
    void thread_start_write();
    void thread_tmp1_fu_741_p2();
    void thread_tmp_1357_fu_783_p1();
    void thread_tmp_1358_fu_570_p1();
    void thread_tmp_1359_fu_737_p1();
    void thread_tmp_1360_fu_767_p1();
    void thread_tmp_138_fu_771_p1();
    void thread_tmp_139_fu_555_p2();
    void thread_tmp_140_fu_747_p2();
    void thread_tmp_141_fu_679_p1();
    void thread_tmp_142_fu_592_p2();
    void thread_tmp_144_fu_603_p2();
    void thread_tmp_146_fu_623_p2();
    void thread_tmp_147_fu_643_p2();
    void thread_tmp_148_fu_652_p2();
    void thread_tmp_149_fu_658_p2();
    void thread_tmp_150_fu_755_p1();
    void thread_tmp_156_fu_709_p2();
