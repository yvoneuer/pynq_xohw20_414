...
entity Resid_StreamingDataW_8 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Resid_StreamingDataW_8 is 
    ...
    signal t_3_fu_115_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal t_3_reg_202 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal i_8_fu_124_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_8_reg_207 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_155_reg_222 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    signal tmp_156_fu_173_p4 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_reg_198 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_155_reg_222 <= eo_V_0_s_reg_81(62 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_phi_mux_t_phi_fu_97_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_reg_198, t_reg_93, t_3_reg_202)
    begin
    ...
    i_8_fu_124_p2 <= std_logic_vector(unsigned(i_fu_52) + unsigned(ap_const_lv32_1));
    ...
    phitmp5_cast_fu_183_p3 <= (in_V_V_dout & tmp_156_fu_173_p4);
    phitmp_cast_fu_167_p3 <= (tmp_V_reg_217 & tmp_155_reg_222);
    ...
    t_3_fu_115_p2 <= std_logic_vector(unsigned(ap_phi_mux_t_phi_fu_97_p4) + unsigned(ap_const_lv10_1));
    tmp_156_fu_173_p4 <= eo_V_1_s_reg_69(62 downto 1);
    tmp_s_fu_130_p2 <= "1" when (i_8_reg_207 = ap_const_lv32_40) else "0";
end behav;
