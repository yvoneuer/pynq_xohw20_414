...
#ifndef _StreamingConvolution_4_HH_
#define _StreamingConvolution_4_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "BlackBoxJam_mux_42_128_1_1.h"
#include "StreamingConvolution_4_inputBuf_0_0_V.h"

namespace ap_rtl {

struct StreamingConvolution_4 : public sc_module {
    ...
    // Module declarations
    StreamingConvolution_4(sc_module_name name);
    SC_HAS_PROCESS(StreamingConvolution_4);

    ~StreamingConvolution_4();

    sc_trace_file* mVcdFile;

    StreamingConvolution_4_inputBuf_0_0_V* inputBuf_0_0_V_U;
    StreamingConvolution_4_inputBuf_0_0_V* inputBuf_0_1_V_U;
    StreamingConvolution_4_inputBuf_0_0_V* inputBuf_1_0_V_U;
    StreamingConvolution_4_inputBuf_0_0_V* inputBuf_1_1_V_U;
    StreamingConvolution_4_inputBuf_0_0_V* inputBuf_2_0_V_U;
    StreamingConvolution_4_inputBuf_0_0_V* inputBuf_2_1_V_U;
    StreamingConvolution_4_inputBuf_0_0_V* inputBuf_3_0_V_U;
    StreamingConvolution_4_inputBuf_0_0_V* inputBuf_3_1_V_U;
    BlackBoxJam_mux_42_128_1_1<1,1,128,128,128,128,2,128>* BlackBoxJam_mux_42_128_1_1_U532;
    BlackBoxJam_mux_42_128_1_1<1,1,128,128,128,128,2,128>* BlackBoxJam_mux_42_128_1_1_U533;
    ...
    sc_signal< sc_lv<1> > tmp_reg_887;
    sc_signal< sc_lv<1> > tmp_s_reg_896;
    sc_signal< sc_logic > ap_CS_fsm_pp0_stage0;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< bool > ap_block_pp0_stage0;
    sc_signal< sc_lv<1> > or_cond_reg_937;
    sc_signal< sc_logic > out_V_V_blk_n;
    sc_signal< sc_lv<1> > tmp_s_reg_896_pp0_iter1_reg;
    sc_signal< sc_lv<1> > tmp_159_reg_900;
    sc_signal< sc_lv<1> > tmp_159_reg_900_pp0_iter1_reg;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<7> > i_reg_391;
    ...
    sc_signal< sc_lv<1> > tmp_fu_536_p2;
    ...
    sc_signal< sc_lv<128> > reg_470;
    sc_signal< sc_lv<32> > grp_fu_451_p2;
    sc_signal< sc_lv<32> > reg_482;
    sc_signal< sc_lv<1> > grp_fu_486_p2;
    sc_signal< sc_lv<7> > i_s_fu_542_p2;
    sc_signal< sc_lv<7> > i_s_reg_891;
    sc_signal< sc_lv<1> > tmp_159_fu_557_p2;
    sc_signal< sc_lv<2> > tmp_1362_fu_572_p1;
    sc_signal< sc_lv<2> > tmp_1362_reg_904;
    sc_signal< sc_lv<32> > current_line_in_bloc_fu_582_p2;
    sc_signal< sc_lv<32> > current_line_in_bloc_reg_909;
    sc_signal< sc_lv<1> > tmp_162_fu_594_p2;
    sc_signal< sc_lv<1> > tmp_162_reg_914;
    sc_signal< sc_lv<1> > tmp_164_fu_605_p2;
    sc_signal< sc_lv<1> > tmp_164_reg_918;
    sc_signal< sc_lv<1> > tmp_166_fu_625_p2;
    sc_signal< sc_lv<1> > tmp_166_reg_922;
    sc_signal< sc_lv<32> > ofm_y_8_fu_639_p2;
    sc_signal< sc_lv<32> > ofm_y_8_reg_926;
    sc_signal< sc_lv<1> > tmp_167_fu_645_p2;
    sc_signal< sc_lv<1> > tmp_167_reg_931;
    sc_signal< sc_lv<1> > or_cond_reg_937_pp0_iter1_reg;
    sc_signal< sc_lv<32> > counter_internal_blo_4_fu_685_p2;
    sc_signal< sc_lv<32> > counter_internal_blo_4_reg_941;
    sc_signal< sc_lv<64> > tmp_161_fu_691_p1;
    sc_signal< sc_lv<64> > tmp_161_reg_947;
    sc_signal< sc_lv<1> > tmp_172_reg_975;
    sc_signal< sc_lv<1> > tmp_163_reg_979;
    sc_signal< sc_lv<2> > tmp_160_fu_759_p2;
    sc_signal< sc_lv<2> > tmp_160_reg_983;
    sc_signal< sc_lv<128> > inputBuf_0_0_V_q0;
    sc_signal< sc_lv<128> > inputBuf_0_0_V_loa_reg_989;
    sc_signal< sc_lv<128> > inputBuf_1_0_V_q0;
    sc_signal< sc_lv<128> > inputBuf_1_0_V_loa_reg_994;
    sc_signal< sc_lv<128> > inputBuf_2_0_V_q0;
    sc_signal< sc_lv<128> > inputBuf_2_0_V_loa_reg_999;
    sc_signal< sc_lv<128> > inputBuf_3_0_V_q0;
    sc_signal< sc_lv<128> > inputBuf_3_0_V_loa_reg_1004;
    sc_signal< sc_lv<2> > tmp_1365_fu_779_p1;
    sc_signal< sc_lv<2> > tmp_1365_reg_1029;
    sc_signal< sc_lv<3> > inputBuf_0_1_V_add_4_reg_1033;
    sc_signal< sc_lv<3> > inputBuf_1_1_V_add_4_reg_1038;
    sc_signal< sc_lv<3> > inputBuf_2_1_V_add_4_reg_1043;
    sc_signal< sc_lv<3> > inputBuf_3_1_V_add_4_reg_1048;
    sc_signal< sc_lv<2> > tmp_1361_fu_795_p1;
    sc_signal< sc_lv<2> > tmp_1361_reg_1053;
    sc_signal< sc_lv<3> > inputBuf_0_1_V_add_reg_1057;
    sc_signal< sc_lv<3> > inputBuf_1_1_V_add_reg_1062;
    sc_signal< sc_lv<3> > inputBuf_2_1_V_add_reg_1067;
    sc_signal< sc_lv<3> > inputBuf_3_1_V_add_reg_1072;
    sc_signal< sc_lv<128> > inputBuf_0_1_V_q0;
    sc_signal< sc_lv<128> > inputBuf_0_1_V_loa_reg_1077;
    sc_signal< sc_lv<128> > inputBuf_1_1_V_q0;
    sc_signal< sc_lv<128> > inputBuf_1_1_V_loa_reg_1082;
    sc_signal< sc_lv<128> > inputBuf_2_1_V_q0;
    sc_signal< sc_lv<128> > inputBuf_2_1_V_loa_reg_1087;
    sc_signal< sc_lv<128> > inputBuf_3_1_V_q0;
    sc_signal< sc_lv<128> > inputBuf_3_1_V_loa_reg_1092;
    sc_signal< bool > ap_block_state1;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_logic > ap_condition_pp0_exit_iter0_state2;
    sc_signal< bool > ap_block_pp0_stage1_subdone;
    sc_signal< sc_lv<3> > inputBuf_0_0_V_address0;
    sc_signal< sc_logic > inputBuf_0_0_V_ce0;
    sc_signal< sc_lv<3> > inputBuf_0_0_V_address1;
    sc_signal< sc_logic > inputBuf_0_0_V_ce1;
    sc_signal< sc_logic > inputBuf_0_0_V_we1;
    sc_signal< sc_lv<3> > inputBuf_0_1_V_address0;
    sc_signal< sc_logic > inputBuf_0_1_V_ce0;
    sc_signal< sc_lv<3> > inputBuf_0_1_V_address1;
    sc_signal< sc_logic > inputBuf_0_1_V_ce1;
    sc_signal< sc_logic > inputBuf_0_1_V_we1;
    sc_signal< sc_lv<3> > inputBuf_1_0_V_address0;
    sc_signal< sc_logic > inputBuf_1_0_V_ce0;
    sc_signal< sc_lv<3> > inputBuf_1_0_V_address1;
    sc_signal< sc_logic > inputBuf_1_0_V_ce1;
    sc_signal< sc_logic > inputBuf_1_0_V_we1;
    sc_signal< sc_lv<3> > inputBuf_1_1_V_address0;
    sc_signal< sc_logic > inputBuf_1_1_V_ce0;
    sc_signal< sc_lv<3> > inputBuf_1_1_V_address1;
    sc_signal< sc_logic > inputBuf_1_1_V_ce1;
    sc_signal< sc_logic > inputBuf_1_1_V_we1;
    sc_signal< sc_lv<3> > inputBuf_2_0_V_address0;
    sc_signal< sc_logic > inputBuf_2_0_V_ce0;
    sc_signal< sc_lv<3> > inputBuf_2_0_V_address1;
    sc_signal< sc_logic > inputBuf_2_0_V_ce1;
    sc_signal< sc_logic > inputBuf_2_0_V_we1;
    sc_signal< sc_lv<3> > inputBuf_2_1_V_address0;
    sc_signal< sc_logic > inputBuf_2_1_V_ce0;
    sc_signal< sc_lv<3> > inputBuf_2_1_V_address1;
    sc_signal< sc_logic > inputBuf_2_1_V_ce1;
    sc_signal< sc_logic > inputBuf_2_1_V_we1;
    sc_signal< sc_lv<3> > inputBuf_3_0_V_address0;
    sc_signal< sc_logic > inputBuf_3_0_V_ce0;
    sc_signal< sc_lv<3> > inputBuf_3_0_V_address1;
    sc_signal< sc_logic > inputBuf_3_0_V_ce1;
    sc_signal< sc_logic > inputBuf_3_0_V_we1;
    sc_signal< sc_lv<3> > inputBuf_3_1_V_address0;
    sc_signal< sc_logic > inputBuf_3_1_V_ce0;
    sc_signal< sc_lv<3> > inputBuf_3_1_V_address1;
    sc_signal< sc_logic > inputBuf_3_1_V_ce1;
    sc_signal< sc_logic > inputBuf_3_1_V_we1;
    sc_signal< sc_lv<7> > ap_phi_mux_i_phi_fu_395_p4;
    sc_signal< sc_lv<64> > tmp_169_fu_767_p1;
    sc_signal< sc_lv<64> > tmp_158_fu_783_p1;
    sc_signal< sc_lv<128> > tmp_V_30_fu_799_p6;
    sc_signal< bool > ap_block_pp0_stage1_01001;
    sc_signal< sc_lv<128> > tmp_V_31_fu_809_p6;
    sc_signal< bool > ap_block_pp0_stage0_01001;
    sc_signal< sc_lv<32> > ofm_y_1_fu_78;
    sc_signal< sc_lv<32> > p_ofm_y_8_fu_705_p3;
    sc_signal< sc_lv<32> > ofm_x_1_fu_82;
    sc_signal< sc_lv<32> > ofm_x_8_fu_619_p2;
    sc_signal< sc_lv<32> > k_y_1_fu_86;
    sc_signal< sc_lv<32> > k_y_8_fu_576_p2;
    sc_signal< sc_lv<32> > inp_1_fu_90;
    sc_signal< sc_lv<32> > p_inp_1_fu_698_p3;
    sc_signal< sc_lv<32> > inp_5_fu_738_p2;
    sc_signal< sc_lv<32> > k_x_1_fu_94;
    sc_signal< sc_lv<32> > k_x_8_fu_588_p2;
    sc_signal< sc_lv<32> > read_block_1_fu_98;
    sc_signal< sc_lv<32> > grp_fu_445_p2;
    sc_signal< sc_lv<32> > current_block_write_1_fu_102;
    sc_signal< sc_lv<32> > grp_fu_503_p3;
    sc_signal< sc_lv<32> > current_line_1_fu_106;
    sc_signal< sc_lv<32> > counter_internal_blo_fu_110;
    sc_signal< sc_lv<32> > p_s_fu_726_p3;
    sc_signal< sc_lv<1> > grp_fu_497_p2;
    sc_signal< sc_lv<30> > tmp_1364_fu_654_p4;
    sc_signal< sc_lv<1> > icmp_fu_664_p2;
    sc_signal< sc_lv<1> > tmp_168_fu_670_p2;
    sc_signal< sc_lv<1> > tmp_175_fu_721_p2;
    sc_signal< sc_lv<2> > tmp_1363_fu_749_p1;
    sc_signal< sc_lv<2> > tmp1_fu_753_p2;
    ...
    void thread_ap_phi_mux_i_phi_fu_395_p4();
    ...
    void thread_current_line_in_bloc_fu_582_p2();
    ...
    void thread_grp_fu_503_p3();
    void thread_i_s_fu_542_p2();
    void thread_icmp_fu_664_p2();
    void thread_in_V_V_blk_n();
    void thread_in_V_V_read();
    void thread_inp_5_fu_738_p2();
    ...
    void thread_k_x_8_fu_588_p2();
    void thread_k_y_8_fu_576_p2();
    void thread_ofm_x_8_fu_619_p2();
    void thread_ofm_y_8_fu_639_p2();
    void thread_or_cond_fu_676_p2();
    void thread_out_V_V_blk_n();
    void thread_out_V_V_din();
    void thread_out_V_V_write();
    void thread_p_inp_1_fu_698_p3();
    void thread_p_ofm_y_8_fu_705_p3();
    void thread_p_s_fu_726_p3();
    void thread_real_start();
    void thread_start_out();
    void thread_start_write();
    void thread_tmp1_fu_753_p2();
    void thread_tmp_1361_fu_795_p1();
    void thread_tmp_1362_fu_572_p1();
    void thread_tmp_1363_fu_749_p1();
    void thread_tmp_1364_fu_654_p4();
    void thread_tmp_1365_fu_779_p1();
    void thread_tmp_158_fu_783_p1();
    void thread_tmp_159_fu_557_p2();
    void thread_tmp_160_fu_759_p2();
    void thread_tmp_161_fu_691_p1();
    void thread_tmp_162_fu_594_p2();
    void thread_tmp_164_fu_605_p2();
    void thread_tmp_166_fu_625_p2();
    void thread_tmp_167_fu_645_p2();
    void thread_tmp_168_fu_670_p2();
    void thread_tmp_169_fu_767_p1();
    void thread_tmp_175_fu_721_p2();
