...
#ifndef _StreamingConvolution_HH_
#define _StreamingConvolution_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "BlackBoxJam_mux_42_64_1_1.h"
#include "StreamingConvolution_inputBuf_0_0_V.h"

namespace ap_rtl {

struct StreamingConvolution : public sc_module {
    ...
    // Module declarations
    StreamingConvolution(sc_module_name name);
    SC_HAS_PROCESS(StreamingConvolution);

    ~StreamingConvolution();

    sc_trace_file* mVcdFile;

    StreamingConvolution_inputBuf_0_0_V* inputBuf_0_0_V_U;
    StreamingConvolution_inputBuf_0_0_V* inputBuf_0_1_V_U;
    StreamingConvolution_inputBuf_0_0_V* inputBuf_1_0_V_U;
    StreamingConvolution_inputBuf_0_0_V* inputBuf_1_1_V_U;
    StreamingConvolution_inputBuf_0_0_V* inputBuf_2_0_V_U;
    StreamingConvolution_inputBuf_0_0_V* inputBuf_2_1_V_U;
    StreamingConvolution_inputBuf_0_0_V* inputBuf_3_0_V_U;
    StreamingConvolution_inputBuf_0_0_V* inputBuf_3_1_V_U;
    BlackBoxJam_mux_42_64_1_1<1,1,64,64,64,64,2,64>* BlackBoxJam_mux_42_64_1_1_U89;
    BlackBoxJam_mux_42_64_1_1<1,1,64,64,64,64,2,64>* BlackBoxJam_mux_42_64_1_1_U90;
    ...
    sc_signal< sc_lv<1> > tmp_140_reg_888;
    sc_signal< sc_lv<1> > tmp_140_reg_888_pp0_iter1_reg;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<13> > i_reg_389;
    ...
    sc_signal< sc_lv<13> > i_s_fu_540_p2;
    sc_signal< sc_lv<13> > i_s_reg_879;
    sc_signal< sc_lv<1> > tmp_140_fu_555_p2;
    sc_signal< sc_lv<2> > tmp_1382_fu_570_p1;
    sc_signal< sc_lv<2> > tmp_1382_reg_892;
    sc_signal< sc_lv<32> > current_line_in_bloc_fu_580_p2;
    sc_signal< sc_lv<32> > current_line_in_bloc_reg_897;
    sc_signal< sc_lv<1> > tmp_145_fu_592_p2;
    sc_signal< sc_lv<1> > tmp_145_reg_902;
    sc_signal< sc_lv<1> > tmp_147_fu_603_p2;
    sc_signal< sc_lv<1> > tmp_147_reg_906;
    sc_signal< sc_lv<1> > tmp_149_fu_623_p2;
    sc_signal< sc_lv<1> > tmp_149_reg_910;
    sc_signal< sc_lv<32> > ofm_y_2_fu_637_p2;
    sc_signal< sc_lv<32> > ofm_y_2_reg_914;
    sc_signal< sc_lv<1> > tmp_150_fu_643_p2;
    sc_signal< sc_lv<1> > tmp_150_reg_919;
    sc_signal< sc_lv<1> > or_cond_reg_925_pp0_iter1_reg;
    sc_signal< sc_lv<32> > counter_internal_blo_19_fu_673_p2;
    sc_signal< sc_lv<32> > counter_internal_blo_19_reg_929;
    sc_signal< sc_lv<64> > tmp_144_fu_679_p1;
    sc_signal< sc_lv<64> > tmp_144_reg_935;
    sc_signal< sc_lv<1> > tmp_156_reg_963;
    sc_signal< sc_lv<1> > tmp_146_reg_967;
    sc_signal< sc_lv<2> > tmp_143_fu_747_p2;
    sc_signal< sc_lv<2> > tmp_143_reg_971;
    ...
    sc_signal< sc_lv<2> > tmp_1384_fu_767_p1;
    sc_signal< sc_lv<2> > tmp_1384_reg_1017;
    sc_signal< sc_lv<5> > inputBuf_0_1_V_add_12_reg_1021;
    sc_signal< sc_lv<5> > inputBuf_1_1_V_add_12_reg_1026;
    sc_signal< sc_lv<5> > inputBuf_2_1_V_add_12_reg_1031;
    sc_signal< sc_lv<5> > inputBuf_3_1_V_add_12_reg_1036;
    sc_signal< sc_lv<2> > tmp_1381_fu_783_p1;
    sc_signal< sc_lv<2> > tmp_1381_reg_1041;
    sc_signal< sc_lv<5> > inputBuf_0_1_V_add_reg_1045;
    sc_signal< sc_lv<5> > inputBuf_1_1_V_add_reg_1050;
    sc_signal< sc_lv<5> > inputBuf_2_1_V_add_reg_1055;
    sc_signal< sc_lv<5> > inputBuf_3_1_V_add_reg_1060;
    ...
    sc_signal< sc_lv<13> > ap_phi_mux_i_phi_fu_393_p4;
    sc_signal< sc_lv<64> > tmp_153_fu_755_p1;
    sc_signal< sc_lv<64> > tmp_139_fu_771_p1;
    sc_signal< sc_lv<64> > tmp_V_50_fu_787_p6;
    sc_signal< bool > ap_block_pp0_stage1_01001;
    sc_signal< sc_lv<64> > tmp_V_51_fu_797_p6;
    sc_signal< bool > ap_block_pp0_stage0_01001;
    sc_signal< sc_lv<32> > ofm_y_1_fu_76;
    sc_signal< sc_lv<32> > p_ofm_y_2_fu_693_p3;
    sc_signal< sc_lv<32> > ofm_x_1_fu_80;
    sc_signal< sc_lv<32> > ofm_x_2_fu_617_p2;
    sc_signal< sc_lv<32> > k_y_1_fu_84;
    sc_signal< sc_lv<32> > k_y_2_fu_574_p2;
    sc_signal< sc_lv<32> > inp_s_fu_88;
    sc_signal< sc_lv<32> > p_inp_s_fu_686_p3;
    sc_signal< sc_lv<32> > inp_1_fu_726_p2;
    sc_signal< sc_lv<32> > k_x_1_fu_92;
    sc_signal< sc_lv<32> > k_x_2_fu_586_p2;
    sc_signal< sc_lv<32> > read_block_1_fu_96;
    sc_signal< sc_lv<32> > grp_fu_443_p2;
    sc_signal< sc_lv<32> > current_block_write_s_fu_100;
    ...
    sc_signal< sc_lv<1> > tmp_151_fu_652_p2;
    sc_signal< sc_lv<1> > tmp_152_fu_658_p2;
    sc_signal< sc_lv<1> > tmp_159_fu_709_p2;
    sc_signal< sc_lv<2> > tmp_1383_fu_737_p1;
    ...
    void thread_counter_internal_blo_19_fu_673_p2();
    ...
    void thread_k_x_2_fu_586_p2();
    void thread_k_y_2_fu_574_p2();
    void thread_ofm_x_2_fu_617_p2();
    void thread_ofm_y_2_fu_637_p2();
    void thread_or_cond_fu_664_p2();
    void thread_out_V_V_blk_n();
    void thread_out_V_V_din();
    void thread_out_V_V_write();
    void thread_p_inp_s_fu_686_p3();
    void thread_p_ofm_y_2_fu_693_p3();
    void thread_p_s_fu_714_p3();
    void thread_real_start();
    void thread_start_out();
    void thread_start_write();
    void thread_tmp1_fu_741_p2();
    void thread_tmp_1381_fu_783_p1();
    void thread_tmp_1382_fu_570_p1();
    void thread_tmp_1383_fu_737_p1();
    void thread_tmp_1384_fu_767_p1();
    void thread_tmp_139_fu_771_p1();
    void thread_tmp_140_fu_555_p2();
    void thread_tmp_143_fu_747_p2();
    void thread_tmp_144_fu_679_p1();
    void thread_tmp_145_fu_592_p2();
    void thread_tmp_147_fu_603_p2();
    void thread_tmp_149_fu_623_p2();
    void thread_tmp_150_fu_643_p2();
    void thread_tmp_151_fu_652_p2();
    void thread_tmp_152_fu_658_p2();
    void thread_tmp_153_fu_755_p1();
    void thread_tmp_159_fu_709_p2();
