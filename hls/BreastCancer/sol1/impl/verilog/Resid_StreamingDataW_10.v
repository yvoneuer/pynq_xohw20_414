...
module Resid_StreamingDataW_10 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [254:0] eo_V_1_s_reg_69;
reg   [254:0] eo_V_0_s_reg_81;
reg   [8:0] t_reg_93;
wire   [0:0] exitcond_fu_109_p2;
wire    ap_block_state2_pp0_stage0_iter0;
reg    ap_block_state4_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [8:0] t_13_fu_115_p2;
reg   [8:0] t_13_reg_202;
reg    ap_enable_reg_pp0_iter0;
wire   [31:0] i_13_fu_124_p2;
reg   [31:0] i_13_reg_207;
wire   [0:0] tmp_s_fu_130_p2;
wire    ap_block_state3_pp0_stage1_iter0;
reg    ap_block_state5_pp0_stage1_iter1;
reg    ap_block_pp0_stage1_11001;
reg   [0:0] tmp_V_reg_217;
reg   [253:0] tmp_165_reg_222;
wire   [254:0] phitmp_cast_fu_167_p3;
wire   [254:0] phitmp5_cast_fu_183_p3;
reg    ap_block_state1;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg    ap_block_pp0_stage1_subdone;
reg   [8:0] ap_phi_mux_t_phi_fu_97_p4;
wire   [255:0] eo_0_V_fu_139_p3;
reg    ap_block_pp0_stage0_01001;
wire   [255:0] eo_1_V_fu_158_p3;
reg    ap_block_pp0_stage1_01001;
reg   [31:0] i_fu_52;
wire   [253:0] tmp_166_fu_173_p4;
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_198 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_165_reg_222 <= {{eo_V_0_s_reg_81[254:1]}};
    end
end
...
assign exitcond_fu_109_p2 = ((ap_phi_mux_t_phi_fu_97_p4 == 9'd256) ? 1'b1 : 1'b0);

assign i_13_fu_124_p2 = (i_fu_52 + 32'd1);

assign phitmp5_cast_fu_183_p3 = {{in_V_V_dout}, {tmp_166_fu_173_p4}};

assign phitmp_cast_fu_167_p3 = {{tmp_V_reg_217}, {tmp_165_reg_222}};

assign start_out = real_start;

assign t_13_fu_115_p2 = (ap_phi_mux_t_phi_fu_97_p4 + 9'd1);

assign tmp_166_fu_173_p4 = {{eo_V_1_s_reg_69[254:1]}};

assign tmp_s_fu_130_p2 = ((i_13_reg_207 == 32'd256) ? 1'b1 : 1'b0);

endmodule //Resid_StreamingDataW_10
