...
set C_modelArgList {
	...
	{ out_V_offset int 61 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "memOutStrm_V_V", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out_V_offset", "interface" : "fifo", "bitwidth" : 61, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out_V_offset_dout sc_in sc_lv 61 signal 2 } 
	{ out_V_offset_empty_n sc_in sc_logic 1 signal 2 } 
	{ out_V_offset_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_V_offset_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "out_V_offset", "role": "dout" }} , 
 	{ "name": "out_V_offset_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_V_offset", "role": "empty_n" }} , 
 	{ "name": "out_V_offset_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out_V_offset", "role": "read" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state3", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_Stream2Mem_fu_38"}],
		"Port" : [
			{"Name" : "memOutStrm_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Stream2Mem_fu_38", "Port" : "in_V_V"}]},
			{"Name" : "in_V", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Stream2Mem_fu_38", "Port" : "out_V"}]},
			{"Name" : "out_V_offset", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "out_V_offset_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Stream2Mem_fu_38", "Parent" : "0",
		"CDFG" : "Stream2Mem",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	Stream2Mem_Batch {
		memOutStrm_V_V {Type I LastRead 2 FirstWrite -1}
		in_V {Type O LastRead 2 FirstWrite 3}
...
set Spec2ImplPortList { 
	...
	out_V_offset { ap_fifo {  { out_V_offset_dout fifo_data 0 61 }  { out_V_offset_empty_n fifo_status 0 1 }  { out_V_offset_read fifo_update 1 1 } } }
}
set moduleName Stream2Mem_Batch
set isTaskLevelControl 1
set isCombinational 0
